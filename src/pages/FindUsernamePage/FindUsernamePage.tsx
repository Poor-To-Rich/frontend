...
import DisplayFoundUsername from '@/pages/FindUsernamePage/components/DisplayFoundUsername';
  ...
  return (
    <div className="flex flex-col h-screen items-center justify-center">
      ...
      {isSuccess || isNotFound ? (
        <DisplayFoundUsername isNotFound={isNotFound} username={data?.data?.username} />
      ) : (
        <FormProvider {...method}>
